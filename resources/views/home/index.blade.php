      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6 text-center text-md-start">
          ...
          <p class="text-muted mb-4">
            Transforming industries with cutting-edge solutions and unwavering commitment to excellence. Join us on our
        ...
        <div class="col-md-6 text-center">
          <div class="position-relative">
            <img
              src="https://images.pexels.com/photos/942540/pexels-photo-942540.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
    ...
    <div class="container about-section">
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae semper odio. Integer consequat augue at
            libero auctor, sed varius justo ullamcorper. Vivamus euismod, metus eget fermentum laoreet, leo orci
            volutpat turpis, a vehicula lorem elit eget libero.</p>
          <p>Nullam tristique, urna eget tristique efficitur, mauris odio facilisis enim, sit amet eleifend turpis lorem
            eu turpis. Duis vel nulla a odio faucibus euismod. Fusce vehicula ipsum a purus laoreet, ac faucibus sapien
  ...
  <section id="services" class="py-5">
    <div class="container text-center">
      ...
      <p class="mt-3">
        ...
        Cras venenatis euismod malesuada. Nulla facilisi. Phasellus euismod purus non nisi cursus, sit amet elementum
      ...
      <div class="row mt-4">
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img
              src="https://images.pexels.com/photos/8159/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="Category 1" class="card-img-top rounded">
            <div class="card-body">
              <h5 class="fw-bold">Category 1</h5>
              <p class="text-muted">8 Products Available</p>
        ...
        <div class="col-md-4">
          <div class="card border-0">
            <img
              src="https://images.pexels.com/photos/1474993/pexels-photo-1474993.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="Category 1" class="card-img-top rounded">
            <div class="card-body">
              <h5 class="fw-bold">Category 1</h5>
              <p class="text-muted">8 Products Available</p>
    ...
    <div class="container text-center">
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-3">
          <div class="card border-0">
            <img
              src="https://images.pexels.com/photos/1098982/pexels-photo-1098982.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        ...
        <div class="col-md-3">
          <div class="card border-0">
            <img
              src="https://images.pexels.com/photos/7219179/pexels-photo-7219179.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            ...
            <div class="accordion-item mb-3">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                ...
                <div class="accordion-body" style="color: #6c757d;">
                  It takes 2–3 weeks to get your first blog post ready. That includes in-depth research and creation of
                  your monthly content marketing strategy that we do before writing your first blog post.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item mb-3">
              <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="color: #000;">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                data-bs-parent="#faqAccordionLeft">
                <div class="accordion-body" style="color: #6c757d;">
                  We begin with an introductory meeting to align goals, followed by brainstorming ideas and presenting
                  an action plan.
                </div>
              </div>
            </div>
          ...
          <div class="accordion" id="faqAccordionRight">
            ...
            <div class="accordion-item mb-3">
              ...
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                ...
                <div class="accordion-body" style="color: #6c757d;">
                  We offer blog writing, SEO optimization, and content marketing strategy services tailored to your
                  needs.
                </div>
              </div>
            </div>
            ...
            <div class="accordion-item mb-3">
              <h2 class="accordion-header" id="headingFour">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  style="color: #000;">
                  Do we provide revisions?
                </button>
              </h2>
              <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                data-bs-parent="#faqAccordionRight">
                <div class="accordion-body" style="color: #6c757d;">
                  Yes, we offer up to 2 free revisions per blog post to ensure your satisfaction with the final content.
                </div>
              </div>
            </div>
          </div>
