                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card p-3 mb-2">
                            <h6><strong>Jonathan Burke Jr.</strong> <small class="text-muted">7:30 PM</small></h6>
                            <p>Lorem ipsum for designers...</p>
                            <input type="text" class="form-control form-control-sm" placeholder="Comment">
                        </div>
                        <div class="card p-3">
                            <h6><strong>Adam Jones</strong> <small class="text-muted">5 days ago</small></h6>
                            <div class="row g-2">
                                <div class="col-6"><img src="https://via.placeholder.com/300" class="img-fluid"></div>
                                <div class="col-6 d-flex flex-wrap">
                                    <img src="https://via.placeholder.com/150" class="img-fluid me-1 mb-1">
                                    <img src="https://via.placeholder.com/150" class="img-fluid">
                                </div>
                            </div>
                            <input type="text" class="form-control form-control-sm mt-2" placeholder="Comment">
                        </div>
                    </div>
                </div>
            </div>
